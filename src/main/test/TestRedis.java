import com.mxp.services.RedisService;
...
public class TestRedis {
    ...
    public static void main(String[] args) {
        ApplicationContext app = new ClassPathXmlApplicationContext("classpath*:spring_config.xml");
        ...
        redisService.hset("k1","v1","s1");

        System.out.println(redisService.hget("k1","v1"));
